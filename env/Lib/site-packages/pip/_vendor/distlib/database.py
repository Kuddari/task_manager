...
def get_dependent_dists(dists, dist):
    ...
    เริ่มทำ = graph.reverse_list[dist]  # list of nodes we should inspect
...
def get_required_dists(dists, dist):
    ...
    เริ่มทำ = graph.adjacency_list[dist]  # list of nodes we should inspect
    seen = set(t[0] for t in เริ่มทำ)  # already added to เริ่มทำ
